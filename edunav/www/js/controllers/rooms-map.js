angular.module('edunav.controllers').controller('RoomsMapCtrl', roomsMapController)

roomsMapController.$inject = ["$scope", "BackendService", "$ionicLoading", "$stateParams", "StorageService"];

function roomsMapController($scope, BackendService, $ionicLoading, $stateParams, StorageService) {
